...
- [ ] Task: Update `src/logic_test.rs` to remove tests related to `handle_target_input` and keyboard keys 1-8. Ensure tests for `update_sequence_logic` verify auto-transitioning without input.
